...
const textarea_full: string = `${styles.input_textfield} w-full text-sm resize-none h-36 text-tbfColor-darkergrey rounded-lg p-2 border border-tbfColor-middlegrey4`;
