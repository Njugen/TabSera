...
function TabItem(props: iTabItem): JSX.Element {
    ...
    return (<>
        <div data-testid="tab-item" className="bg-white border border-tbfColor-middlegrey2 hover:border-tbfColor-lightpurple hover:bg-tbfColor-lighterpurple hover:text-tbf-middlegrey2 transition-all rounded-md ease-in duration-100 tab-item my-2 flex items-center justify-between">
            <a href={url} rel="noreferrer" className="inline-block w-full py-2 text-sm flex hover:no-underline items-center truncate px-2 tab-item-info" target="_blank">
