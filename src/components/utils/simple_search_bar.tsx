...
function SimpleSearchBar(props: iSimpleSearchBar): JSX.Element {
    ...
    return (
        <div className={`w-full flex items-center relative  z-[501] text-sm h-10 opacity-50 bg-gray-200 focus:opacity-90 border-tbfColor-lightergrey focus:outline-0 focus:outline-tbfColor-lighterpurple4 focus:shadow-md hover:shadow py-5 pr-5 rounded-3xl`}>
