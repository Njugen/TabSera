...
function AddToWorkspacePopup(props: iAddToWorkspacePopup): JSX.Element {
    ...
    return (
        <div data-testid="add-to-workspace-popup" className={styleDirection()}>
            <div className="w-[992px] relative bg-white rounded-lg leading-7 text-md px-8 py-4">
                <div className="flex justify-center">
                    <h1 className="text-3xl text-tbfColor-darkpurple font-light inline-block text-center">
                        { title }
                    </h1>
                </div>
