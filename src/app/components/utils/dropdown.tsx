...
function Dropdown(props: iDropdown): JSX.Element {
    ...
    function applyClasses(id: number): string {
        if(selected === id){
            ...
            return "hover:bg-tbfColor-lightgrey border-b border-tbfColor-middlegrey hover:border-tbfColor-middlegrey5 flex items-center text-sm text-tbfColor-darkergrey weight-bold px-3 py-6 h-10 w-full";
        }
    }
